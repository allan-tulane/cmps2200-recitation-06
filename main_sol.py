...
class BinaryHeap:
    ...
    def deleteMin(self):
        """
        Remove the root node to return its value and restore the heap property
        using reheapDown.
